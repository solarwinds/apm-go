...
Every Go source file must start with the SolarWinds copyright header:
...
<!-- the source of this file is https://github.com/solarwinds-sandbox/copilot/blob/main/.github/instructions/go.instructions.md -->
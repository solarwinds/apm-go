...
[![GoDoc](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao?status.svg)](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao)
[![Build Status](https://travis-ci.org/solarwindscloud/solarwinds-apm-go.svg?branch=master)](https://travis-ci.org/solarwindscloud/solarwinds-apm-go)
[![codecov](https://codecov.io/gh/solarwindscloud/solarwinds-apm-go/branch/master/graph/badge.svg)](https://codecov.io/gh/solarwindscloud/solarwinds-apm-go)
[![Go Report Card](https://goreportcard.com/badge/github.com/solarwindscloud/solarwinds-apm-go)](https://goreportcard.com/report/github.com/solarwindscloud/solarwinds-apm-go)
...
* This package: go get github.com/solarwindscloud/solarwinds-apm-go/v1/ao
...
[ao.HTTPHandler](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#HTTPHandler) wrapper.  This
...
hostname, etc. [ao.HTTPHandler](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#HTTPHandler)
...
```
![sample_app screenshot](https://github.com/solarwindscloud/solarwinds-apm-go/raw/master/img/readme-ao-screenshot1.png)
![sample_app screenshot2](https://github.com/solarwindscloud/solarwinds-apm-go/raw/master/img/readme-ao-screenshot2.png)
...
[BeginSpan()](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#BeginSpan) or
[Info()](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#Span), and
[End()](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#Span). We also provide helper methods
such as [BeginQuerySpan()](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#BeginQuerySpan),
[BeginCacheSpan()](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#BeginCacheSpan),
[BeginRemoteURLSpan()](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#BeginRemoteURLSpan),
[BeginRPCSpan()](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#BeginRPCSpan), and
[BeginHTTPClientSpan()](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#BeginHTTPClientSpan)
...
[ao.BeginSpan](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#BeginSpan) returns both a
new Span and an associated context, and
[ao.Info(ctx)](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#Info) and
[ao.End(ctx)](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#Span) both use the Span
...
the [Trace](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#Trace) and
[Span](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao#Span) interfaces directly, if it
...
If you have installed AppOptics and this package, you can run the sample “web app” included with appoptics-apm-go:
    ...
    $ cd $GOPATH/src/github.com/solarwindscloud/solarwinds-apm-go/examples/sample_app
    $ go run main.go
...
source in each service's subdirectory, or by using docker-compose:
    ...
    $ cd $GOPATH/src/github.com/solarwindscloud/solarwinds-apm-go/examples/distributed_app
...
<img width=729 src="https://github.com/solarwindscloud/solarwinds-apm-go/raw/master/img/readme-ao-screenshot3.png">

### OpenTracing

Support for the OpenTracing 1.0 API is available in the [opentracing](https://godoc.org/github.com/solarwindscloud/solarwinds-apm-go/v1/ao/opentracing) package as a technology preview. The
...
import(
  ...
  aotracing "github.com/solarwindscloud/solarwinds-apm-go/v1/ao/opentracing"
)

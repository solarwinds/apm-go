...
func TestTextMapExtract(t *testing.T) {
	...
	carrier.Set(solarwinds_apm.HTTPHeaderName, textCarrier[solarwinds_apm.HTTPHeaderName])
	...
	apmCarrier := opentracing.TextMapCarrier{}
	apmCarrier.Set(solarwinds_apm.HTTPHeaderName, textCarrier[solarwinds_apm.HTTPHeaderName])
	ctx, err = tr.Extract(opentracing.TextMap, apmCarrier)
	assert.NotNil(t, ctx)
	assert.NoError(t, err)
	...
	invalidCarrier.Set(solarwinds_apm.HTTPHeaderName, "!!!")
	...
	invalidCarrier = opentracing.TextMapCarrier{}
	invalidCarrier.Set(solarwinds_apm.HTTPHeaderName, textCarrier[solarwinds_apm.HTTPHeaderName])

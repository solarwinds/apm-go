...
// CreateResource builds an OpenTelemetry resource with SolarWinds-specific attributes
// and optional caller-supplied key-value pairs.
...
func getOptionalDetectors() []resource.Detector {
	...
	var optionalDetectors []resource.Detector
